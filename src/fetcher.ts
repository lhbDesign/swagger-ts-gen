...
export type FetchResult = { ok: true; doc: SwaggerDocument } | { ok: false; error: StructuredError };
 ...
 */
export async function fetchSwaggerDoc(options: FetchOptions): Promise<FetchResult> {
