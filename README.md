...
[中文](#swagger-ts-gen中文) | [English](#swagger-ts-gen-english)

---

# swagger-ts-gen (English)
...
swagger-ts-gen --file src/api/user.ts --swagger https://your-api/doc.html --dry-run
```
...
```bash
swagger-ts-gen --file src/api/user.ts --swagger "https://your-yapi.com/api/plugin/export?type=swagger&pid=123&token=abc123"
```
